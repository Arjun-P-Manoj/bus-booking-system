    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="pt-28 pb-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm border border-gray-100 hover:border-indigo-100 transition-colors duration-300">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex items-center space-x-4 w-full sm:w-auto">
                <div className="flex items-center">
                  ...
                  >
                    Available buses only
                  </label>
                </div>
              </div>
              <span className="text-sm sm:text-base text-gray-500 bg-gray-50 px-3 py-1.5 rounded-full w-full sm:w-auto text-center">
                Showing {availableBuses.length} buses
              </span>
            </div>
          </div>
        </div>
